...
no_environments  = 5 #how many different mujuco envs we want to generate
num_objects = 1
...
for env_no in range(0, no_environments):
    xmlfile = create_object_xml(base_filename, num_objects, object_mass,
